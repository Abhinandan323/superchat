...
function App() {
  ...
  return (
    ...
    <div className="container-fluid" ><Headroom>
      <nav className="navbar navbar-expand-sm bg-primary justify-content-end" style={{ border: '3px solid white', borderRadius: '5px' }}>
        <h2 className='navbar'> Super Chat</h2>
        <ul className="navbar-nav justify-content-end">

          <li className="nav-item" align='left'>
            <img className='App-logo pic' src={logo} alt="logo" />
          </li>
          <li className="nav-item" style={{ color: 'white' }}><b>Dark Mode :ON</b><label className="switch">
  ...
  return (
    <>
      <div className="jumbotron text-center bg-primary">
        ...
        <h1>Super Chat Room</h1>
      </div>
      <div className="d-flex justify-content-center" >
        <button className="btn btn-success btn-md" onClick={signInWithGoogle}><h1>Sign in <b className="fa fa-google"></b> </h1></button>
      </div>
      <hr />
      <div class="container" >
        <div className="row">
          <div className="col-sm-4 text-center bg-info" style={{ borderRadius: '20px' }} >
            ...
            <p>This is a simple chat room based on ReactJs with a backend support of firebase created by:<br /> Aryaman:Firebase & React<br />Abhinandan:BootStrap & React<br />Dipanshu:Bootstrap &CSS<br />Abhinav:React &Js</p>
          </div>
    ...
    <>
      ...
      <div className="container-fluid" >
        <form onSubmit={sendMessage} >
          ...
          <button type="submit" className="btn btn-info" style={{ fontSize: '24px', border: '3px solid #61daf', borderRadius: '0px 30px 30px 0px' }}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-chat" viewBox="0 0 16 16">
